...
if($akun[2]!='Monitoring'){header('location: '.$host);}
...
if (empty($_GET['l'])) {
	include('inc/monitoring/index.php');
	
}elseif($_GET['l']=='cabang'){
	include('inc/monitoring/cabang.php');

}elseif($_GET['l']=='akun2'){
	include('inc/monitoring/akun2.php');
	
}elseif($_GET['l']=='akun3'){
	include('inc/monitoring/akun3.php');
	
}elseif($_GET['l']=='log'){
	include('inc/monitoring/log.php');
				
}else{
	include('inc/monitoring/index.phpp');
}
